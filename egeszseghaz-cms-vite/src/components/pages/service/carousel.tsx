...
export default function ServiceCarousel({ service }: { service: Service }) {
  ...
  const items = (() => {
    if (images.length === 1) {
      return [{ i: index, pos: "center" as const }];
    }
      ...
      <div className="relative max-w-6xl mx-auto flex flex-col items-center gap-12 sm:gap-16 md:gap-20 z-10">
        ...
        <div className="relative flex items-center justify-center gap-4 sm:gap-8 md:gap-10 py-4 sm:py-6 w-full">
          {items.map(({ i, pos }) => {
            ...
            const side = pos !== "center";

            // mobile: hide non-center images entirely
              ...
              <BlurFade key={`${pos}-${i}`} delay={0.05} direction="up">
                <div
                  className={`
                    ...
                    ${
                      center
                        ? "scale-[1.05] sm:scale-[1.1] md:scale-[1.15] z-20"
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      // tablet sizes
                      ...(center && {
                        "@screen sm": { width: 320, height: 420 },
                      }),
                      ...(center && {
                        "@screen md": { width: 380, height: 520 },
                      }),
                    }}
                  >
                    {/* Top gradient */}
